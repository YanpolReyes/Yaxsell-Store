  ...
  return (
    <>
      <style>{`
        ...
        .notif-card:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,0,0,0.06); border-color: rgba(227,150,191,0.2); }
        .notif-card.unread { background: linear-gradient(135deg,#fdf2f8,#fff); border-left: 3px solid ${PINK}; }
