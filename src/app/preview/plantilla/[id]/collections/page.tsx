...
const TEMPLATE_COMPONENTS: Record<number, any> = {
  5: dynamic(() => import('@/templates/plantilla5/CollectionList'), { ssr: false }),
  100: dynamic(() => import('@/templates/plantilla100/CollectionList'), { ssr: false }),
};
...
export default function PreviewCollectionListPage() {
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif' }}>
        <div style={{ textAlign: 'center' }}>
          <p style={{ fontSize: 18, fontWeight: 700, color: '#374151' }}>Plantilla no encontrada para Colecciones</p>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontWeight: 700, color: '#f1f5f9' }}>
            👁️ Vista previa (Colecciones) — Plantilla {id}: {TEMPLATE_NAMES[id]}
          </span>
        </div>
      </div>
