  ...
  if (totalItems === 0) return (
    <>
      ...
      <div style={{ minHeight: '100vh', position: 'relative', fontFamily: FF }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '24px 5%', minHeight: '100vh' }}>
          ...
          <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap', alignItems: 'flex-start' }}>
            <div style={{ flex: 1, minWidth: 300, background: '#fff', borderRadius: 18, padding: '40px 32px', border: '1px solid #f0f0f0', display: 'flex', alignItems: 'center', gap: 28 }}>
            ...
            <div style={{ width: 300, flexShrink: 0, background: '#fff', borderRadius: 18, padding: '24px 20px', border: '1px solid #f0f0f0' }}>
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', position: 'relative', fontFamily: FF }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '24px 5%' }}>
          ...
          <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: 300, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ background: '#fff', borderRadius: 14, padding: '14px 20px', border: '1px solid #f0f0f0', display: 'flex', alignItems: 'center', gap: 10 }}>
                <Truck size={18} color={PINK} />
                <span style={{ fontSize: 14, color: '#1a1a1a', fontWeight: 500 }}>Envío disponible a todo Chile</span>
              </div>

              <div style={{ background: '#fff', borderRadius: 14, padding: '0 20px', border: '1px solid #f0f0f0' }}>
                  ...
                  return (
                    <div key={p.$id} className="cart-item">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {hasDisc && (
                          <p style={{ margin: '0 0 2px', fontSize: 12, color: '#9ca3af', textDecoration: 'line-through' }}>{formatPrice(p.PRICE)}</p>
                        )}
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 4 }}>
                          <span style={{ fontSize: 20, fontWeight: 700, color: '#1a1a1a' }}>{formatPrice(price)}</span>
                          {hasDisc && <span style={{ fontSize: 13, fontWeight: 600, color: '#16a34a' }}>{discPct}% OFF</span>}
                        </div>

                        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginTop: 12 }}>
                          <div style={{ display: 'flex', alignItems: 'center', borderRadius: 10, overflow: 'hidden', border: '1px solid #e5e7eb' }}>
                            <button onClick={() => updateQuantity(p.$id, item.quantity - 1)} className="qty-btn" style={{ borderRight: 'none', borderRadius: '10px 0 0 10px' }}>−</button>
                            ...
                            <button onClick={() => updateQuantity(p.$id, item.quantity + 1)} disabled={item.quantity >= p.STOCK} className="qty-btn" style={{ borderLeft: 'none', borderRadius: '0 10px 10px 0' }}>+</button>
                          </div>
            ...
            <div style={{ width: 300, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ background: '#fff', borderRadius: 14, padding: '24px 20px', border: '1px solid #f0f0f0' }}>
              ...
              <div style={{ background: '#fff', borderRadius: 14, padding: '18px 20px', border: '1px solid #f0f0f0' }}>
