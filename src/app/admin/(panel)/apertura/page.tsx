...
export default function AperturaPage() {
  ...
  return (
    <div style={{ fontFamily: FF }}>
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 32, border: '1px solid #fce7f3', boxShadow: '0 4px 24px rgba(236,72,153,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 32, paddingBottom: 24, borderBottom: '1px solid #fce7f3' }}>
          <div style={{ width: 48, height: 48, borderRadius: 12, background: 'linear-gradient(135deg,#ec4899,#f43f5e)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 20, background: '#fdf2f8', borderRadius: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: isActive ? 'linear-gradient(135deg,#ec4899,#f43f5e)' : '#e5e7eb',
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
            <button
              ...
              style={{
                ...
                background: saving ? '#9ca3af' : 'linear-gradient(135deg,#ec4899,#f43f5e)',
