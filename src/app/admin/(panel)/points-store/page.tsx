    ...
    <div style={{ padding: '24px 28px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: 48, background: '#fff', borderRadius: 16, border: '1px solid #e5e7eb' }}>
          <Coins size={40} color="#ec4899" style={{ marginBottom: 12 }} />
          ...
          {items.map((item) => (
            <div key={item.$id} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: 16, background: '#fff', borderRadius: 14, border: '1px solid #e5e7eb' }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ margin: '4px 0 0', fontSize: 12, fontWeight: 700, color: '#ec4899' }}>{item.POINTSCOST.toLocaleString()} pts</p>
              </div>
...
const btnPri: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: 6, padding: '10px 16px', background: '#ec4899', color: '#fff', border: 'none', borderRadius: 10, fontWeight: 700, cursor: 'pointer', fontSize: 13 };
