...
import { Truck, Plus, Save, Trash2, CheckCircle, Edit2, X, GripVertical } from 'lucide-react';
...
const DEFAULTS: Agency[] = [
  { id: 'starken',   name: 'STARKEN',          color: '#1a7f37', bg: '#e6f4ea', desc: 'Entrega rápida y confiable',   logo: 'https://media.licdn.com/dms/image/v2/C510BAQGf7frAaAcogw/company-logo_200_200/company-logo_200_200/0/1631323622266?e=2147483647&v=beta&t=PQt6O5DgEP72brYnRu0ypoR_k9rrAIQ7XAHmQL0Q1uM', active: true },
  { id: 'bluexpress', name: 'BLUEXPRESS',       color: '#1558b0', bg: '#e8f0fe', desc: 'Servicio express premium',    logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSz2T8HSqmWqmSShlCx8iGNP2tkT_OGLK4cdg&s', active: true },
  { id: 'varmontt',  name: 'VARMONTT',          color: '#c62828', bg: '#fce8e6', desc: 'Cobertura nacional completa', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEPQN4hjn8F2PQXVmphZVnstiaQTEs4ILyArmNbu1DjCaj2EfwPxnUnEWLEUivCr_95IE&usqp=CAU', active: true },
  { id: 'retiro',    name: 'RETIRO EN TIENDA',  color: '#e65c00', bg: '#fff3e0', desc: 'Retira en nuestra sucursal',  logo: '', active: true },
];

const LS_KEY = 'store_agencies';
...
function saveAgencies(agencies: Agency[]) {
...
export default function AgenciasPage() {
  ...
  useEffect(() => { setAgencies(loadAgencies()); }, []);
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleSave}
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white transition-colors ${saved ? 'bg-green-500' : 'bg-indigo-600 hover:bg-indigo-700'}`}>
