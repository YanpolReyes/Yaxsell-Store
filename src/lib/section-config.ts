...
export const SECTION_DEFAULTS: SectionConfig[] = [
  ...
  },
  {
    ...
    enabled: true,
    order: 24,
    settings: { bgColor: '#f9fafb', textColor: '#374151', headingColor: '#111', cardBgColor: '#ffffff', cardTextColor: '#374151', accentColor: '#f59e0b', title: 'MIRA LO QUE DICEN', borderRadius: 12, shadow: 'sm', padding: 40, testimonials: [
      { name: 'Olivia Kranz', text: 'La atención en Kevin & Coco es excepcional. El personal es súper amable y conoce perfectamente todos los productos. Me ayudaron a encontrar exactamente lo que buscaba. ¡Volveré sin duda!', avatar: 'https://randomuser.me/api/portraits/women/44.jpg', rating: 5 },
      { name: 'Jessica López', text: 'Excelente servicio y rapidez en la entrega. Hice mi pedido online y llegó en tiempo récord, todo bien empaquetado. La comunicación fue clara en todo momento. Muy recomendable.', avatar: 'https://randomuser.me/api/portraits/women/68.jpg', rating: 5 },
      { name: 'Sophia Mendoza', text: 'Me encanta la variedad de productos que tienen en la tienda de Toesca. El ambiente es acogedor y siempre encuentro novedades. Los precios son justos y la calidad es excelente.', avatar: 'https://randomuser.me/api/portraits/women/33.jpg', rating: 5 },
      { name: 'Emily Rodríguez', text: 'Compro regularmente en Kevin & Coco y nunca me han decepcionado. La relación calidad-precio es increíble y el servicio post-venta es de primera. ¡Son los mejores!', avatar: 'https://randomuser.me/api/portraits/women/17.jpg', rating: 5 },
      { name: 'Camila Fuentes', text: 'La tienda es hermosa y muy bien organizada. El personal te asesora sin presionar y te explica todo con paciencia. Además, tienen promociones constantes. ¡Me encanta comprar aquí!', avatar: 'https://randomuser.me/api/portraits/women/55.jpg', rating: 5 },
    ] },
  },
  {
    id: 'newsletter',
      ...
      heroSlides: [
        {
          ...
          title: 'MUSK COSMO',
          subtitle: 'CONFIDENT CHARM',
          alignment: 'center',
        },
        {
          imageUrl: '/shopify/assets/img/9jo523yvuya95av2-82653806840.shopifypreview.com/cdn/shop/t/3/assets/hero-apparel-2-m6chhr.svg',
          title: 'Grooming Next Level Fashion',
          subtitle: 'COSMÉTICOS ACCESIBLES',
          description: "It's about blending style with sophistication, where modern grooming meets trend-forward fashion to create a sharp, confident look.",
          btnPrimaryText: 'MÁS INFO',
          btnSecondaryText: 'COMPRAR AHORA',
          alignment: 'left',
        },
        {
          imageUrl: '/shopify/assets/img/9jo523yvuya95av2-82653806840.shopifypreview.com/cdn/shop/t/3/assets/hero-apparel-2-m6chhr.svg',
          title: 'Siempre Usa Protector Solar',
          subtitle: 'TRENDING NOW',
          description: 'Protege tu piel de los rayos UV dañinos, previniendo el envejecimiento prematuro y el daño solar. Un hábito diario simple que mantiene tu piel sana, radiante y juvenil.',
          btnPrimaryText: 'MÁS INFO',
          btnSecondaryText: 'COMPRAR AHORA',
          alignment: 'left',
        },
  ...
  },
  {
    ...
    order: 10,
    settings: {
      collectionTitle: 'NUESTRAS COLECCIONES',
      collectionSubtitle: 'COSMÉTICOS ACCESIBLES',
      collectionDescription: 'Explora nuestras colecciones cosméticas curadas con fórmulas premium para realzar la belleza natural en cada tono de piel.',
      collectionItems: [],
    },
  },
  {
    ...
    order: 11,
    settings: {
      marqueeText1: 'Beauty Redefined',
      marqueeText2: 'Gracefully Ageless',
      marqueeText3: 'Timeless Elegance',
  ...
  },
  {
    ...
    order: 12,
    settings: {
      featuredCollectionSubtitle: 'ESTUDIO DE BELLEZA',
      featuredCollectionTitle: 'COLECCIONES DESTACADAS',
      featuredCollectionDescription: 'Descubre nuestras colecciones de belleza destacadas con esenciales lujosos, tonos refinados y fórmulas de alto rendimiento que a todos encantan.',
  ...
  },
  {
    ...
    order: 13,
    settings: {
      mediaGalleryTitle: 'MUSK COSMO',
      mediaGalleryItems: [
        {
          title: 'COMPRA LOS MÁS VENDIDOS',
          mediaUrl: '/shopify/assets/img/9jo523yvuya95av2-82653806840.shopifypreview.com/cdn/shop/t/3/assets/lifestyle-2-ia4ie.svg',
          mediaType: 'image',
          buttonText: 'COMPRAR AHORA',
          link: '',
        },
        {
          title: 'SELECCIONES IMPRESCINDIBLES',
          mediaUrl: '/shopify/assets/img/9jo523yvuya95av2-82653806840.shopifypreview.com/cdn/shop/t/3/assets/lifestyle-2-ia4ie.svg',
          mediaType: 'image',
          buttonText: 'COMPRAR AHORA',
          link: '',
  ...
  },
  {
    ...
    order: 14,
    settings: {
      featuredProductSubtitle: 'REVERSO INSTANTÁNEO DE LA EDAD',
      featuredProductTitle: 'PRODUCTO DESTACADO',
      featuredProductDescription: 'Conoce nuestro producto destacado, un esencial de belleza destacado que combina innovación moderna, ingredientes amantes de la piel y rendimiento lujoso.',
  ...
  },
  {
    ...
    settings: {
      countdownOfferId: '',
      countdownSlideText: 'COMPRA UNO Y LLEVA OTRO GRATIS',
      countdownTitle: 'MASCARILLA FACIAL FEMENINA',
      countdownSubtitle: 'Entra al mundo de la elegancia atemporal y la protección moderna.',
  ...
  },
  {
    ...
    order: 16,
    settings: {
      productsFilterSubtitle: 'SELECCIONES TOP',
      productsFilterTitle: 'PESTAÑA DE COLECCIÓN',
      productsFilterDescription: 'Navega por nuestras colecciones cuidadosamente seleccionadas, creadas para la belleza moderna y la confianza diaria.',
  ...
  },
  {
    ...
    order: 17,
    settings: {
      beforeAfterSubtitle: 'COMPRA NUESTROS FAVORITOS',
      beforeAfterTitle: 'ANTES Y DESPUÉS',
      beforeAfterDescription: 'Ve resultados reales con nuestros visuales de antes y después mostrando transformaciones visibles usando nuestros productos de belleza premium y de alto rendimiento.',
  ...
  },
  {
    ...
    order: 20,
    settings: {
      marquee2Text1: 'Beauty Redefined',
      marquee2Text2: 'Gracefully Ageless',
      marquee2Text3: 'Timeless Elegance',
  ...
  },
  {
    ...
    order: 21,
    settings: {
      overlaySubheading: 'Distribuidor Oficial',
      overlayHeading: 'Kevin & Coco Chile',
      overlayParagraph: '¡Eleva tu rutina de belleza con lo último en cosmética internacional! Somos el único distribuidor oficial de Kevin & Coco en Chile. Fusión perfecta entre calidad profesional y diseños adorables. Desde paletas de alta pigmentación hasta skincare con acabado glow.',
      overlayBtnText: 'Ver Productos',
      overlayBtnLink: '/productos',
      overlayBgImage: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=1920&q=80',
      overlayBlurAmount: 0,
      overlayOverlayOpacity: 0.4,
      overlayOverlayColor: '#000000',
      overlayTextColor: '#f9a8d4',
      overlaySubheadingColor: '#ec4899',
      overlayFontFamily: 'inherit',
      overlayFontSize: 18,
      overlayFontWeight: 400,
      overlayBorderRadius: 0,
      overlayParticlesEnabled: true,
      overlayParticlesColor: '#ec4899',
  ...
  },
  {
    ...
    order: 22,
    settings: {
      vtHeading: 'Kevin & Coco Chile',
      vtSubtitle: 'Distribuidor Oficial',
      vtDescription: '¡Eleva tu rutina de belleza con lo último en cosmética internacional! Somos el único distribuidor oficial de Kevin & Coco en Chile. En nuestra sede de Toesca, encontrarás la fusión perfecta entre calidad profesional y los diseños más adorables del mercado. Desde paletas de alta pigmentación hasta skincare con acabado glow, tenemos todo para que tu brillo sea único.',
      vtBtnText: 'Explorar Productos',
      vtBtnLink: '/productos',
      vtVideoUrl: '',
      vtPosterImage: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&q=80',
      vtMediaPosition: 'left',
      vtBorderRadius: 20,
      vtHeadingColor: '#f9a8d4',
      vtTextColor: '#374151',
      vtBgColor: '#fdf2f8',
      padding: 60,
      height: 450,
  ...
  },
  {
    ...
    order: 26,
    settings: {
      title: '¿Por qué elegir Kevin & Coco Chile?',
      items: [
        { icon: 'truck', title: 'Envío a Todo Chile', description: 'Despacho rápido y seguro a todo el país. Santiago en 24-48 hrs.' },
        { icon: 'shield-check', title: 'Pago Seguro', description: 'Tarjeta, transferencia, WebPay y contraentrega. 100% protegido.' },
        { icon: 'message-circle', title: 'Soporte WhatsApp', description: 'Atención personalizada por WhatsApp de lunes a sábado.' },
        { icon: 'sparkles', title: '100% Original', description: 'Productos auténticos Kevin & Coco. Garantía de autenticidad.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    locked: true,
    settings: {
      logoUrl: 'https://jumpseller.s3.eu-west-1.amazonaws.com/store/yes-bella/assets//Sin título-1_5d514a8074f0023fe88b0eacda93c729.png?1743456840',
      companyName: 'Kevin & Coco Chile',
      companyDescription: 'Marca de maquillaje de renombre internacional. Productos de alta calidad profesional con empaques creativos y encantadores. Representantes exclusivos y únicos mayoristas en Chile.',
      ...
      footerLinks: [
        ...
        { title: 'Mayoristas', url: '/mayoristas' },
      ...
      showMap: true,
      mapEmbed: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3329.6447!2d-70.6593!3d-33.4489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9662c5a0e0e0e0e0%3A0x0!2sToesca%202537%2C%20Santiago!5e0!3m2!1ses!2scl!4v1234567890',
    },
  },
  {
